...
e2s_Elegant_Lattices_Directory = '/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_LATTICES/'
sys.path.insert(0, e2s_Elegant_Lattices_Directory)
e2s_Elegant_Scripts='/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_ELEGANT/'
sys.path.insert(0, e2s_Elegant_Scripts)
from srwlib import *
from uti_plot import *

#sys.path.insert(0, '/dls/physics/xph53246/source_to_beamline/E2S/e2s_BLOPTICS')
sys.path.insert(0, '/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_BLOPTICS/')
...
def Update_Accelerator_Optics(LATTICE, IDpos, bx,ax,by,ay,ex,exp, ex0,Sdelta0,Cou,Sz0,Circ):
    ...
    os.chdir("/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_LATTICES/")
    ...
    #cou  = 0.01
    os.chdir("/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_SRW")
...
def CalcIntensity(currentOptBL,bx,ax,by,ay,ex,exp, SRWInputFile,rootnumber): #JL:modified to calculate with I20 beamline 
    ...
    wfr2.mesh.nx     =  200   #from Ji's low resolution calculation,600x600 is the minimum to show I20 aberration
    wfr2.mesh.ny     =  200
