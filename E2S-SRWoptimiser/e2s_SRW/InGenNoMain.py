...
sys.path.insert(0, '/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_SRW/ANALYSIS/')
...
def func_optBL(k13,k14,k15,k16,k17,bx,ax,by,ay,ex,exp, rootnumber):    # NOTE : ROOTNUMBER TAG HERE #HERE
    ...
    OutputFolder='/dls/physics/students/sug89938/E2S_JL/E2S-SRWopimiser/e2s_SRW/SRW_I20S/multi-e__'+rootnumber+'*' #FBT: will not work if just the directory is given # NOTE : ROOTNUMBER TAG HERE
