...
def DefineBLOptics(BLname,slitDX,slitDY):
    ...
    if BLname == 'I13a':
        Ephot = 11209. # to be changed .... 
        oe_pp = optBL_I13a.optBL(slitDX, slitDY, Ephot)  # define the oe/pp container 
    ...
    if BLname == 'I13d_test':    
        #Ephot = 11210    to test Harry-Potter's zero magic number
        Ephot = 11214 # to be changed .... correct value at 3GeV
    ...
    if BLname == 'I13d_MA':
        ...
        print(slitDX)
        print(slitDY)
       #Ephot = 11210 # Harry Potter will not like this number at 3GeV!!!
        Ephot = 11209. # at 3 GeV # to be changed .... 
       #Ephot = 15256. #at 3.5 GeV
       #Ephot = 15260. #at 3.5 GeV, just for Harry Potter. Do not use if you don't like magic !!
       #Ephot = 7090
    ...
    if BLname == 'I20_scan':      # from Ji      
        Ephot = 8700.0000000001 # to be changed .... 
