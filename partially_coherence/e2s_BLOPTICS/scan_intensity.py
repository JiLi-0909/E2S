...
sampFactNxNyForProp = 0.25  # 0.25*2 #sampling factor for adjusting nx, ny (effective if > 0)
...
optBL = DefineBLOptics(BLname,300,120)
...
if(srwl_uti_proc_is_master()):
    ...
    srwl.CalcIntFromElecField(arI3, wfr2, 6, 0, 3, wfr2.mesh.eStart, 0, 0)  # FBT 0 instead of 1
    print('  done')
