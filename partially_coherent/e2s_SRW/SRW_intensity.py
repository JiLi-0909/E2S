...
sys.path.insert(0, '/dls/physics/students/sug89938/MultiElectrons/e2s_BLOPTICS/')
...
sampFactNxNyForProp = 0.2# 0.25*2 #sampling factor for adjusting nx, ny (effective if > 0)
