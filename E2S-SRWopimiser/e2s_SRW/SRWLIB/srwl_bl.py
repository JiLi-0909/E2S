...
#OC16102017
    ...
    def calc_wfr_prop(self, _wfr, _pres_ang=0, _pol=6, _int_type=0, _dep_type=3, _fname='', _det=None): #OC06122016
        ...
        # MA 15/1/2018 
        print('len(arEx) = ', len(_wfr.arEx),'_wfr.arEx=',  _wfr.arEx[9826:9830], 'len(arEy) = ', len(_wfr.arEy),' _wfr.arEy=',  _wfr.arEy[9826:9830])
        print(' Re(E) / Im(E)',  map(add,_wfr.arEx[9826:9830],_wfr.arEy[9826:9830]) )
        ...
        if(_int_type >= 0): 
            ...
            if(len(_fname) > 0):
                ...
                print('Saving Propagation Results ... ', _fname, ' ',  end='')
                t0 = time.time();
