...
###### os.system('./submit_runbatch_Individual.sh')
        ...
        #os.system(' /dls_sw/apps/python/anaconda/1.7.0/64/bin/python SRW_I13d_intensity.py SRW.input')
            ...
            #os.system(' /dls_sw/apps/python/anaconda/1.7.0/64/bin/python SRW_intensity_test.py')
...
#            os.system('./submit_runbatch_Individual.sh')
        ...
        elif calc_type == 'multie-optimiser':
            print("SRW - optimiser CALCULATION - interactive mode ... (JL test)")
            print(os.getcwd())
            os.system(' /dls_sw/apps/python/anaconda/1.7.0/64/bin/python SRW_intensity_optimiser.py SRW.input')#SRW_wfrnew.py

        elif calc_type == 'multie-2wfr':
            print("SRW - 2 watchpoint CALCULATION - interactive mode ... (JL test)")
            print(os.getcwd())
            os.system(' /dls_sw/apps/python/anaconda/1.7.0/64/bin/python SRW_intensity_2wfr.py SRW.input')

        elif calc_type == 'bending':
            print("SRW - 2 watchpoint CALCULATION - interactive mode ... (JL test)")
            print(os.getcwd())
            os.system(' /dls_sw/apps/python/anaconda/1.7.0/64/bin/python SRW_intensity_bend.py SRW.input')
        ...
        #print('\n\n\n\n\n FBT end of calc  here  ------------------------------------------   test step F.E.\n\n\n\n\n')
        print(' testing numpy, from E2S.py...')
        data2 = []
        for i in range(5):
            data2.append(i)

        data2 = np.array(data2) # re-assign data after the loop
        print(data2)
        ...
        if Brightness ==1:
            ...
            input_twi         = e2s_LATTICES+'/'+LATTICE+'.twi'#e2s_LATTICES+'/'+'DTBA_21_5_1.twi'#e2s_LATTICES+'/'+LATTICE+'.twi'  #'DTBA_C1a_AA.twi'
